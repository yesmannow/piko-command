...
import { User, Heart, MessageCircle, Send, Bookmark } from 'lucide-react'
...
export function PlatformPreview({ caption, selectedPlatforms }: PlatformPreviewProps) {
  ...
  const formatCaption = (text: string, platform: string) => {
  ...
  return (
    <Card className="border-2 border-zinc-800 bg-zinc-950/90 backdrop-blur-xl">
      <CardHeader className="border-b border-zinc-800/50">
        <CardTitle className="text-lg uppercase tracking-wider font-black flex items-center gap-3">
        ...
        <Tabs defaultValue={availablePlatforms[0]} className="w-full">
          ...
          {availablePlatforms.includes('instagram') && (
            <TabsContent value="instagram" className="mt-4">
              <div className="border-2 border-zinc-800 rounded-lg overflow-hidden bg-black">
                ...
                <div className="p-4 bg-zinc-950 space-y-3">
                  ...
                  <div className="text-sm">
                    ...
                    <span 
                      ...
                      dangerouslySetInnerHTML={{ __html: formatCaption(caption.slice(0, 200), 'instagram') }}
                    />
                    {caption.length > 200 && (
              ...
              <div className="border-2 border-zinc-800 rounded-lg overflow-hidden bg-black">
                ...
                <div className="p-4 bg-zinc-950">
                  <div className="text-sm">
                    ...
                    <span 
                      className="text-zinc-300 leading-relaxed"
                      dangerouslySetInnerHTML={{ __html: formatCaption(caption.slice(0, 150), 'tiktok') }}
                    />
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div 
                        ...
                        dangerouslySetInnerHTML={{ __html: formatCaption(caption, 'twitter') }}
                      />
                    </div>
                  </div>
                </div>
          ...
          {availablePlatforms.includes('facebook') && (
            <TabsContent value="facebook" className="mt-4">
              <div className="border-2 border-zinc-800 rounded-lg overflow-hidden bg-zinc-950">
                ...
                <div className="p-4">
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ __html: formatCaption(caption, 'facebook') }}
                  />
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="linkedin" className="mt-4">
              <div className="border-2 border-zinc-800 rounded-lg overflow-hidden bg-zinc-950">
                ...
                <div className="p-4">
                  <div 
                    className="text-zinc-200 text-sm leading-relaxed whitespace-pre-wrap"
                    dangerouslySetInnerHTML={{ __html: formatCaption(caption, 'linkedin') }}
                  />
                </div>
              </div>
            </TabsContent>
