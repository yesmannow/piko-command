          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-2">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge className="bg-cyan-500/20 text-cyan-400 border-cyan-500/50 text-xs font-mono">
              ...
              <div className="border-2 border-cyan-500/30 rounded-lg overflow-hidden bg-black hover:border-cyan-500/60 transition-all">
                <div className="p-4 bg-zinc-950 space-y-2">
                  <div className="flex gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center text-white text-sm font-black">
                      P
                    </div>
