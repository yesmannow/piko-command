      ...
      <CardHeader className="border-b border-zinc-800/50">
        <CardTitle className="text-xl uppercase tracking-wider font-black flex items-center gap-3">
          ...
          <span className="bg-gradient-to-r from-lime-400 to-emerald-400 bg-clip-text text-transparent">
            POSTIZ-STYLE PREVIEW
          </span>
        </CardTitle>
        <p className="text-xs text-zinc-500 mt-1">Side-by-side X vs Instagram comparison</p>
      </CardHeader>
      <CardContent className="p-6">
        <div className="space-y-4">
          <div className="flex items-center justify-center gap-2 pb-2">
            <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/50 font-black uppercase">
              <XLogo className="w-3 h-3 mr-1" weight="bold" />
              X (Twitter)
            </Badge>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-sm font-black uppercase tracking-wider text-blue-400 flex items-center gap-2">
                  <XLogo className="w-4 h-4" weight="bold" />
                  X (Twitter)
                </h3>
                <Badge className={`${fullCaption.length > 280 ? 'bg-red-500/20 text-red-400 border-red-500/50' : 'bg-lime-500/20 text-lime-400 border-lime-500/50'} text-xs font-mono`}>
                  {fullCaption.length}/280
                </Badge>
              </div>
              <div className="border-2 border-blue-500/30 rounded-lg overflow-hidden bg-black hover:border-blue-500/60 transition-all">
                <div className="bg-zinc-950 p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-lime-400 to-emerald-400 flex items-center justify-center text-zinc-950 text-sm font-black flex-shrink-0">
                      P
                    </div>
